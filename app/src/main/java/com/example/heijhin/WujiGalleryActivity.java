...
public class WujiGalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wuji_gallery);
    ...
    private void initializedata(){
        String[] artTitles = getResources().getStringArray(R.array.art_title_wuji);
        ...
        TypedArray artImages = getResources().obtainTypedArray(R.array.wuji_gallery);
